...
urlpatterns = [
    ...
    path('api/courses/', CourseListCreate.as_view(), name='course-list-create'),  # Trailing slash for REST convention
    path('api/courses/<int:pk>/', CourseDetail.as_view(), name='course-detail'),  # Detail for course
